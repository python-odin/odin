...
class SerializerTestCase(unittest.TestCase):
    def test_date_iso_format(self):
        self.assertEqual("2014-01-16", serializers.date_iso_format(datetime.date(2014, 01, 16)))
    ...
    def test_datetime_iso_format(self):
        self.assertEqual(
            ...
            serializers.DatetimeIsoFormat(datetimeutil.utc)(
                datetime.datetime(2014, 01, 16, 0, 29, 32)))
        self.assertEqual(
            "2014-01-16T00:29:32+10:00",
            serializers.DatetimeIsoFormat(datetimeutil.utc)(
                datetime.datetime(2014, 01, 16, 0, 29, 32, tzinfo=datetimeutil.FixedTimezone(10, 0, "10:00"))))
