    ...
    def test_full_mapping(self):
        assertMappingEquivalent(
            [
                ...
                FieldMapping(
                    ("from_field_c1", "from_field_c2", "from_field_c3"),
                    "multi_to_one",
                    ("to_field_c1",),
                    False,
                    False,
                ...
                FieldMapping(
                    ("count",), "default_action", ("count",), False, False, False
                ),
                FieldMapping(
                ...
                FieldMapping(
                    ("title",), "default_action", ("title",), False, False, False
                ),
            ],
    ...
    def test_unknown_from_field_mappings(self):
        with pytest.raises(MappingSetupError):
            ...
            class _(odin.Mapping):
                ...
                mappings = (("unknown_field", None, "title"),)
    ...
    def test_unknown_from_field_mappings_multiple(self):
        with pytest.raises(MappingSetupError):
            ...
            class _(odin.Mapping):
                ...
                mappings = ((("title", "unknown_field"), None, "title"),)
    ...
    def test_bad_action_not_defined(self):
        with pytest.raises(MappingSetupError):
            ...
            class _(odin.Mapping):
                ...
                mappings = (("title", "do_transform", "title"),)
    ...
    def test_unknown_to_field_mappings(self):
        with pytest.raises(MappingSetupError):
            ...
            class _(odin.Mapping):
                ...
                mappings = (("title", None, "unknown_field"),)
    ...
    def test_unknown_to_field_mappings_multiple(self):
        with pytest.raises(MappingSetupError):
            ...
            class _(odin.Mapping):
                ...
                mappings = (("title", None, ("title", "unknown_field")),)
    ...
    def test_invalid_list_to_multiple_mapping(self):
        with pytest.raises(MappingSetupError) as cm:
            ...
            class _(odin.Mapping):
                ...
                mappings = (("title", None, ("title", "name"), True, False, False),)

        assert "specifies a to_list mapping, these can only be applied to a" in str(
            cm.value
        )
    ...
    def test_assignment_with_no_action(self):
        with pytest.raises(MappingSetupError) as cm:
            ...
            class _(odin.Mapping):
                ...
                mappings = ((None, None, ("title", "name"), False, False, False),)
...
class TestExecuteMapping:
    ...
    def test_apply_multiple_resources_with_context(self):
        ...
        to_resource_iter = SimpleFromTo.apply(from_resources)
        assert isinstance(to_resource_iter, MappingResult)
        assert ["0: Foo", "1: Bar", "2: Eek"] == [
            t.title_count for t in to_resource_iter
        ]


class TestResourceMappingHelpers:
...
class TestSubClassMapping:
    ...
    *Mapping A-X* to the corresponding *Resource Y* and *Resource Z* objects.
    ...
    def test_abstract_mapping(self):
        source = [
            ResourceB(foo="1", bar="2"),
            ResourceC(foo="3", eek="4"),
            ResourceB(foo="5", bar="6"),
        ]
